...
6. **Write design doc** — save to
   `.sdlc/SPEC<NNN>-<module>-<kebab-case-title>/spec.md` and commit
...
**The terminal state is invoking writing-plans.** Do NOT invoke any
...
- Write the validated design (spec) to
  `.sdlc/SPEC<NNN>-<module>-<kebab-case-title>/spec.md`
  - (User preferences for spec location override this default)
  - Use template at `.sdlc/templates/spec-template.md`
...
- Invoke sdlc:using-git-worktrees to create an isolated workspace before
  proceeding
