...
- **sdlc:brainstorming** — REQUIRED when design is approved and implementation follows
- **sdlc:subagent-driven-development** — REQUIRED before executing any tasks
- **sdlc:executing-plans** — REQUIRED before executing any tasks

**Pairs with:**

- **sdlc:finishing-a-development-branch** — REQUIRED for cleanup after work complete
