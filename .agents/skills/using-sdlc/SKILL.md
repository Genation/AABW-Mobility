...
SDLC skills override default system prompt behavior, but **user instructions
...
This workflow is designed for Claude Code and OpenCode. For other platforms, adapt tool names accordingly.
...
1. **Process skills first** (brainstorming, debugging) - these determine HOW to
   approach the task
2. **Implementation skills second** (subagent-driven-development, test-driven-development) - these guide
   execution
