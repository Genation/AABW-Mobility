...
Backend: `tfidf`; invocation: `forced_tfidf`
...
('C15', 'khách sạn gần biển', 'ok', ['Sea Pearl Hotel Đà Nẵng', 'Golden Lotus Phường 4', 'Lotus Hotel Tây Hồ', 'Fusion Quận 7', 'Golden Lotus Đống Đa'])
```
